...
doIt(){
   if(this.conts){
        ...
        TweenMax.fromTo(this.box.nativeElement, 0.5, {height:600}, {height:0, ease: Power1.easeOut});
        console.log('passou 1')
        
    }else{
        this.conts=true;
        TweenMax.fromTo(this.box2.nativeElement, 1, {paddingLeft:0}, {paddingLeft:200, ease:  Back.easeOut.config(1.7)});
        TweenMax.fromTo(this.box.nativeElement,0.8, {height: 0}, {height:600,delay:1, ease: Back.easeOut.config(1.7)});
